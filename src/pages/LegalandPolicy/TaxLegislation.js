    ...
    const laws = [
        {
            ...
            subpoint: [
                { link: 'http://website.ers.org.sz:8000/documents/CustomsandExciseAct1971.pdf', text: 'Customs and Excise Act 1971' },
                { link: "http://website.ers.org.sz:8000/documents/IncomeTaxOrder1975.pdf", text: 'Income Tax Order 1975' },
                { link: 'http://website.ers.org.sz:8000/documents/ValueAddedTaxAct2011.pdf', text: 'Value Added Tax Act, 2011' },
                { link: 'http://website.ers.org.sz:8000/documents/GradedTaxAct1968.pdf', text: 'Graded Tax Act 1968' },
                { link: 'http://website.ers.org.sz:8000/documents/TheFuelTaxAct2022.pdf', text: 'The Fuel Tax Act 2022' }
            ]
        },
        {
            head: 'Amendments',
            subpoint: [
                { link: 'http://website.ers.org.sz:8000/documents/IncomeTaxAmendmentAct2023.pdf', text: 'Income Tax Amendment Act 2023' },
                { link: 'http://website.ers.org.sz:8000/documents/TheValueAddedTax(Amendment)Act 2022_Schedules.pdf', text: 'The Value Added Tax (Amendment) Act 2022 Schedules' },
                { link: 'http://website.ers.org.sz:8000/documents/TheValueAddedTaxAmendmentAct2022.pdf', text: 'The Value Added Tax Amendment Act 2022' }]
        }
    ]
        ...
        <>
         <PageLayout title={"ERS"} bannerImg={Banner} contentBackground={bgimg}>
            ...
            <Box sx={{ padding: "2rem 0", position:"relative" }}>
                ...
                <Link href={'http://website.ers.org.sz:8000/documents/RevenueAuthorityAct2008.pdf'} style={{ color: '#2f2483'}} className='Pointsformatting'> Revenue Authority Act 2008</Link></Typography>
