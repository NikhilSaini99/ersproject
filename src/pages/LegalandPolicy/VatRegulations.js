        ...
        <>
           <PageLayout title={"ERS"} bannerImg={Banner} contentBackground={bgimg}>
            ...
            <Box sx={{ padding: "2rem 0", position:"relative" }}>
                ...
                <Typography variant='h6' className='Pointsformatting'>The VAT Regulations <Link href={'http://172.30.200.21:8000/documents/TheVATRegulations.pdf'} target='_blank'
                ...
                <Link href='http://172.30.200.21:8000/documents/VATRateAmendmentRegulation2018.pdf' target='_blank'><Typography variant="body1" className='Pointsformatting' sx={{ color: '#2f2483', }} >VAT (Rate) (Amendment) Regulation 2018</Typography></Link>
