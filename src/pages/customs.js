      ...
      <section className="m-14 w-4/5 mx-auto">
        ...
        <div className=" my-5">
          ...
          <ul className="grid grid-cols-2 gap-x-32 text-mainColor text-[15px] px-4 leading-7 font-normal">
            ...
            <a href = "http://102.36.181.16:8000/documents/SACUCorrelationTable.pdf">SACU Correlation Table</a>
            </li>
            <li className="hover:underline cursor-pointer starclass">
            <a href = "http://102.36.181.16:8000/documents/Schedule1Part1.pdf">Schedule 1 Part 1</a>
            </li>
            <li className="hover:underline cursor-pointer starclass">
            <a href = "http://102.36.181.16:8000/documents/Schedule1Part1LegalNotes.pdf">Schedule 1 Part 1 Legal Notes</a>
            </li>
            <li className="hover:underline cursor-pointer starclass">
            <a href = "http://102.36.181.16:8000/documents/Schedule1Part2A.pdf">Schedule 1 Part 2A</a>
            </li>
            <li className="hover:underline cursor-pointer starclass">
            <a href = "http://102.36.181.16:8000/documents/Schedule1Part2B.pdf">Schedule 1 Part 2B</a>
            </li>
            <li className="hover:underline cursor-pointer starclass">
            <a href = "http://102.36.181.16:8000/documents/Schedule1Part3D.pdf">Schedule 1 Part 3D</a>
            </li>
            <li className="hover:underline cursor-pointer starclass">
            <a href = "http://102.36.181.16:8000/documents/Schedule1Part3E.pdf">Schedule 1 Part 3E</a>
            </li>
            <li className="hover:underline cursor-pointer starclass">
            <a href = "http://102.36.181.16:8000/documents/Schedule3.pdf">Schedule 3</a> 
            </li>
            <li className="hover:underline cursor-pointer starclass">
