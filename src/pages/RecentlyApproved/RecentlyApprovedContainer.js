        ...
        >
          ...
          >
            <Table aria-label="Tender-Table">
              <TableHead>
                <TableRow
                  sx={{  backgroundColor: "#DFDFDF", "& > *": {  fontWeight: "bold !important",  fontSize: "1rem !important",  textAlign: "center !important",}, }}
                >
              ...
              <TableBody>
                {approvedArryGuidelines?.map((item, index) => (
                  <TableRow
                    key={index}
                  ...
                  >
                    ...
                    <TableCell>
                      <Button
                        variant="contained" color="primary"  sx={{ backgroundColor: "#2F2483 !important" }}  onClick={() => handlePDFDownload(item.documentUrl)}
                      >
                        Downlaod
                      </Button>
                    </TableCell>
