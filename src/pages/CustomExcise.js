    ...
    <PageLayout title={"Services"} bannerImg={Banner} contentBackground={bgimg}>
        ...
        <Box sx={{ padding: "2rem 0", position:"relative" }}>
          ...
          <Typography variant="body1">
            ...
            <Link href="http://website.ers.org.sz:3000/CustomExcise/FreeTrade"> here.</Link> Customs in Eswatini is administered by the ERS Customs and Excise Department in accordance with the Customs and Excise Act of 1971. The Department performs key functions for the country&apos;s development including:`
          </Typography>
