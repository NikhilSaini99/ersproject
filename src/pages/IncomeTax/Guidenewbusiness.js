        ...
        <>
            <PageLayout title={"Eswatini Income Tax"} bannerImg={Banner} contentBackground={bgimg}>
                ...
                <Box sx={{ padding: "2rem 0", position:"relative" }}>
                    ...
                    <Link href="http://102.36.181.16:8000/documents/Step-ByStepGuideforNewBusinesses.pdf" className='Pointsformatting text-normalBlue'>Click Here to download Guide for New Businesses</Link>
                </ContentDiv>
            </PageLayout>
        </>
    )
