        ...
        <PageLayout title={"Reverse Charge Concept"} bannerImg={Banner} contentBackground={bgimg}>       
           ...
           <Box sx={{ padding: "2rem 0", position:"relative" }}>
                ...
                <Typography variant='body1' className='Pointsformatting'>
                    The  <Link href={"http://website.ers.org.sz:8000/documents/ReverseChargeDeclarationForm.pdf"} style={{color:"#2f2483"}}> VAT reverse charge declaration form </Link> and payment must be submitted to the ERS within 30 days of the invoice date.</Typography>
