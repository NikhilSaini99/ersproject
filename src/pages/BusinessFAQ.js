import {
  ...
  import Banner from "../assets/images/business-banner.jpg";
  ...
  export default function BusinessFAQ() {
    ...
    const { fetchAPI, data, isLoading } = useFetch("get", "/api/ourResourceBusiness");
    ...
    return (
      <>
        ...
        <section className="xs:mx-8 sm:mx-20 md:mx-30 lg:mx-30 xl:mx-40 2xl:mx-72 my-14">
          <div>
            <h1 className="text-subColor text-6xl font-bold uppercase">Business FAQ</h1>
