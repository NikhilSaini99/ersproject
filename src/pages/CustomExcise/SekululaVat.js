...
const SekululaVat = () => {
  ...
  const section1Data = [
    ...
    },
    {
      ...
      subhead:
        "The following information must appear on the invoice(s) for it to be regarded as valid for purposes of the VAT Refunds System:",
      points: [
    ...
    {
      downloadData: [
        "<a href = http://website.ers.org.sz:8000/documents/foranexampleofavalidsimplifiedTax-VATInvoice.jpg target = _blank> Click Hear for an example of a valid simplified Tax/VAT Invoice </a>",
        "<a href = http://website.ers.org.sz:8000/documents/foranexampleofavalidfullTax-VATInvoice.jpg target = _blank> Click Hear for an example of a valid full Tax/VAT Invoice </a>",
    ...
    },
    {
      ...
      data: [
        ...
        {
          heading:
            "The following documents should be submitted for claiming VAT paid in South Africa:",
          subpoints: [
        ...
        {
          heading:
            "Importers whose claims are rejected by SARS will be called upon to settle the VAT liability.",
        },
        {
          heading: "B. NON-COMMERCIAL IMPORTERS",
          subpoints: [
    ...
    },
    {
      ...
      subhead:
        "Use of the Sekulula VAT Easy system is allowed for goods imported through the following border posts only:",
      points: [
        "Ngwenya Border Post",
    ...
    },
    {
      ...
      usefulPoints: [
        "A payment receipt issued by the supplier to confirm that goods have been paid for in full",
        "A printed bank statement, where payment has been made using a credit or debit card",
    ...
    },
    {
      ...
      subhead:
        "In order to submit a claim for the VAT paid in RSA which is remitted to the importer upon payment by SARS on the items listed in the preceding section under (viii), an importer who is in possession of a valid VAT /tax invoice will be required to:",
      points: [
