           ...
           <PageLayout title={"Services"} bannerImg={Banner} contentBackground={bgimg}>
                ...
                <Box sx={{ padding: "2rem 0", position:"relative" }}>
                    ...
                    <Typography variant="h2">
                        REBATE CONCESSION FOR NEW/RETURNING RESIDENTS <a href="http://172.30.200.21:8000/documents/RebateCustoms-GuidelineforProcessingRebatesandExemptionsforNew.pdf" target='_blank' style={{color:"blue"}}> (Click here for the full  guideline)</a>
                    </Typography>
