    ...
    return (
        <>
           <PageLayout title={"Services"} bannerImg={Banner} contentBackground={bgimg}>
                ...
                <Typography variant='body1' className='pb-2'>Click here to download the full <Link href="http://102.36.181.16:8000/documents/CustomsProceduresCodesExplanatoryNotes.pdf" className='text-normalBlue Pointsformatting'>Customs Procedures Codes Explanatory notes</Link></Typography>
            </ContentDiv>
            </PageLayout>
        </>
    )
